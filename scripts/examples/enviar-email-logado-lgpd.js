...
module.exports = async (page, scenario, browser) => {
  ...
  async function lgpdFlow(dropdownItem, sendMailFeedback, textarea) {
    await page.waitForSelector(targetElementToWait);

    await page.click(dropdown);
    await page.click(dropdownItem);

    await page.waitForSelector(stillHaveDoubtsButton, {
      visible: true,
    });
    await page.click(stillHaveDoubtsButton);
    await page.waitForSelector(sendMailContainer, {
      visible: true,
    });
    ...
    await page.waitForSelector(sendMailFeedback);
  }
